...
public class Picture extends SimplePicture {
    ...
    public void fixUnderwater() {
        ...
        for (Pixel[] rowArray : pixels) {
            for (Pixel pixelObj : rowArray) {
                pixelObj.setGreen(pixelObj.getGreen() - 125);
                pixelObj.setBlue(pixelObj.getBlue() - 125);
            }
        }
    }
    ...
    public void myCollage() {
        mirrorDiagonal();
        mirrorGull();
        copyTwo(new Picture("koala.jpg"), 80, 400, 100, 300, 300, 400);
        copyTwo(new Picture("seagull.jpg"), 233, 323, 234, 355, 329, 72);
        copyTwo(new Picture("beach.jpg"), 200, 500, 10, 200, 250, 100);
    }
